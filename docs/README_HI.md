...
| `TTS_MODEL_CACHE_SIZE` | `2` | coquitts और kokorotts एक साथ जितने मॉडल लोड रखते हैं; एक और मॉडल का अनुरोध सबसे पहले लोड हुए मॉडल को हटा देता है। |
