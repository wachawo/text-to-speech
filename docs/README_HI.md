...
`language` दो-अक्षर का कोड (`en`, `ru`) या क्षेत्र या लिपि वाला टैग (`zh-cn`, `pt_BR`, `en-gb`, `es-419`) होता है; टैग को छोटे अक्षरों में बदला जाता है और `-` से जोड़ा जाता है। हर इंजन टैग को अपनी उपलब्ध भाषा से मिलाता है: gtts को उसकी अपनी वर्तनी (`zh-CN`; इसमें कनाडाई फ़्रेंच और यूरोपीय पुर्तगाली नहीं हैं, इसलिए `fr-ca` और `pt-pt` का अर्थ `fr` और `pt`) मिलती है, kokorotts `en-gb` को ब्रिटिश फ़ोनेमाइज़र से बोलता है, xtts को चीनी के लिए `zh-cn` मिलता है, और बाकी इंजन भाषा वाला हिस्सा लेते हैं (`pt-br` का अर्थ `pt`)। `stream=true` होने पर अनुरोध का `language` फ़ील्ड पहले की तरह केवल दो-अक्षर के कोड स्वीकार करता है; जिस अनुरोध में `language` नहीं है, वह `TTS_LANGUAGE` को वैसे ही इस्तेमाल करता है जैसा वह सेट है, चाहे वह टैग ही क्यों न हो। जो भाषा इंजन नहीं जानता, वह इंजन की डिफ़ॉल्ट भाषा में बोली जाती है, आम तौर पर अंग्रेज़ी (gtts इसके बजाय विफल होता है); `TTS_LANGUAGE_STRICT=true` होने पर ऐसा अनुरोध 400 पाता है, जिसमें इंजन की भाषाओं की सूची होती है। सख़्त जाँच `stream` के बिना `/api/tts`, `/api/history` और `/v1/audio/speech` पर, और उन सभी इंजनों पर लागू होती है जो अपनी भाषाओं की सूची देते हैं: pyttsx3 और xtts के अलावा किसी बहुभाषी मॉडल वाले coquitts को छोड़कर सभी।
